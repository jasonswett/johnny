class PartOfSpeechAnnotation
  PARTS_OF_SPEECH = {
    ...
    RB: %w(not very quickly slowly carefully quietly loudly happily sadly gently firmly easily barely suddenly always never often sometimes usually rarely where here there everywhere nowhere somewhere above below inside outside nearby far away home abroad upstairs downstairs underground), # Adverb
